  ...
  return (
    <View style={styles.container}>
      <View style={styles.WelcomeView}>
        ...
        <Text style={styles.CompleteYourAccountText}>Agora por favor, me fale sua idade.</Text>
      </View>
      <View style={styles.InputView}>
        ...
        <TouchableOpacity style={styles.buttonDate} onPress={() => setTimePicker(true)}>
