    ...
    <View style={styles.container}>
      <View style={styles.WelcomeView}>
        ...
        <Text style={styles.CompleteYourAccountText}>
          Por último, algumas ultimas informações
        </Text>
      </View>
      <View style={styles.InputView}>
        <Text style={styles.pesoText}>Peso (kg)</Text>
        <TextInput
          style={styles.input}
        ...
        />
        <Text style={styles.pesoText}>Altura (cm)</Text>
        <TextInput
          style={styles.input}
          placeholder={"Insira sua altura atual (cm)"}
          placeholderTextColor={"white"}
